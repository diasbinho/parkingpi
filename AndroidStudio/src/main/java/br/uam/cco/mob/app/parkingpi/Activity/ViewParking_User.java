...
public class ViewParking_User extends AppCompatActivity {
    ...
    private void popularSpinner_Parkings() {
        databaseReference.child("Estacionamentos").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                arrayAdapterEstacionamentos = new ArrayAdapter<Estacionamentos>(ViewParking_User.this,
    ...
    private void searchItemsByParking(String e) {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                arrayAdapterVagas = new ArrayAdapter<Vagas>(ViewParking_User.this,
    ...
    private void inicializarFirebase() {
        FirebaseApp.initializeApp(ViewParking_User.this);
    ...
    */
    private void returnToMainActivity() {
        Intent intent = new Intent(ViewParking_User.this, MenuUser.class);
